...
export CFLAGS="$CFLAGS -O3 -DNDEBUG -D__ANDROID_API__=$ANDROID_NDK_API"
export CPPFLAGS="$CFLAGS"
export CXXFLAGS="$CFLAGS"
export LDFLAGS="$LDFLAGS -L$SYSROOT/usr/lib -L$ANDROID_TOOLCHAIN_ROOT/lib -L$ANDROID_INSTALL_ROOT/lib"
